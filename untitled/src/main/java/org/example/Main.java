...
public class Main {
    public static void main(String[] args) {
        ...
        streams.add(EducationController.newStream("History", 5, 10, 25));
        streams.add(EducationController.newStream("Math", 3, 10, 25));
        streams.add(EducationController.newStream("Biology", 4, 10, 30));
